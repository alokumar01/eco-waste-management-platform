...
<div class="flex h-screen bg-[#F4F7F6] font-sans overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <a href="{{ route('services.create') }}" class="bg-[#1A4D2E] hover:bg-green-900 text-white font-bold text-sm px-4 py-2 rounded-lg transition-colors flex items-center gap-2 shrink-0">
            ...
            <div class="bg-white p-4.5 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/70 flex flex-col justify-between min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <div class="flex items-baseline gap-2">
                        ...
                        <span class="text-[10px] font-bold text-emerald-700 bg-emerald-50/80 px-1.5 py-0.5 rounded truncate">↑ 2 new</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-4.5 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/70 flex flex-col justify-between min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <div class="flex items-baseline gap-2">
                        ...
                        <span class="text-[10px] font-bold text-emerald-700 bg-emerald-50/80 px-1.5 py-0.5 rounded truncate">↑ 15%</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-4.5 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/70 flex flex-col justify-between min-w-0">
                <div class="flex items-center justify-between mb-3">
                    <div class="w-9 h-9 rounded-xl flex items-center justify-center bg-amber-50/70 text-amber-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5h6M9 9h6M9 9a4 4 0 1 1 0 8h2m-2-8h5M13 17l-5-5" />
                        </svg>
                    </div>
                </div>
                <div class="min-w-0">
                    ...
                    <div class="flex items-baseline gap-2">
                        ...
                        <span class="text-[10px] font-bold text-emerald-700 bg-emerald-50/80 px-1.5 py-0.5 rounded truncate">↑ 18%</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-4.5 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100/70 flex flex-col justify-between min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <div class="flex items-baseline gap-2">
                        ...
                        <span class="text-[10px] font-bold text-purple-700 bg-purple-50 px-1.5 py-0.5 rounded truncate">{{ $totalReviews }} reviews</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div class="lg:col-span-2 bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-gray-100">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <select class="border border-gray-200 rounded-xl px-4 py-1.5 text-xs font-medium text-gray-600 bg-white shadow-sm focus:outline-none focus:ring-1 focus:ring-green-500">
                ...
                <div class="flex-1 flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-6 relative min-h-[140px]">
                    ...
                    <div class="flex flex-col gap-4 text-xs font-medium text-gray-600 w-full sm:w-auto">
                        <div class="flex flex-col">
                            <span class="flex items-center gap-2 text-gray-700 font-semibold mb-1"><span class="w-2.5 h-2.5 bg-[#429961] rounded-full shrink-0"></span>Completed</span>
                        ...
                        <div class="flex flex-col">
                            <span class="flex items-center gap-2 text-gray-700 font-semibold mb-1"><span class="w-2.5 h-2.5 bg-[#87D6A3] rounded-full shrink-0"></span>Upcoming</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div class="lg:col-span-1 bg-[#377A4D] text-white p-7 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] flex flex-col relative overflow-hidden order-first lg:order-last">
                <!-- Leaf background decoration -->
                <svg class="absolute bottom-0 right-0 w-48 h-48 text-[#4E9B66] opacity-30 translate-x-12 translate-y-12" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><path d="M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/></svg>
                ...
                <div class="relative z-10 flex flex-col h-full">
                    ...
                    <div class="w-full bg-[#2B603D] rounded-full h-1.5 mb-5 overflow-hidden">
                    ...
                    <a href="{{ route('provider.profile.edit') }}" class="w-full text-center bg-[#184D2C] hover:bg-[#113B21] text-white font-bold py-3 px-4 rounded-xl mt-8 text-xs transition-colors shadow-sm inline-block select-none active:scale-[0.98]">Complete Now</a>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-gray-100 flex flex-col">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('services.index') }}" class="text-[11px] font-bold text-[#1B7339] hover:underline">View All</a>
                    </div>
                    <div class="flex-1 space-y-6 text-sm">
                        @forelse($recentServices as $service)
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($service->name) }}&background=F4F7F6&color=1B7339" alt="Service" class="w-11 h-11 rounded-xl object-cover">
                                <div>
                            ...
                            <div class="flex items-center gap-4">
                                <span class="text-[10px] font-bold text-[#1B7339] bg-[#EAF5EE] px-2.5 py-1 rounded-md">Active</span>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-gray-100 flex flex-col">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('bookings.index') }}" class="text-[11px] font-bold text-[#1B7339] hover:underline">View All</a>
                    </div>
                    <div class="flex-1 space-y-6 text-sm">
                        @forelse($upcomingBookings as $booking)
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div class="bg-gray-50 text-[#1B7339] w-11 h-11 flex items-center justify-center rounded-xl shrink-0 border border-gray-100">
                            ...
                            <span class="text-[10px] font-bold text-[#1B7339] bg-[#EAF5EE] border border-transparent px-2.5 py-1 rounded-md">{{ ucfirst($booking->status) }}</span>
                        </div>
                        @empty
        ...
        <!-- Grow Your Impact -->
        <div class="bg-[#EAF5EE] p-6 rounded-2xl flex flex-col sm:flex-row justify-between items-center gap-4 relative overflow-hidden">
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div>
                    <h2 class="text-[16px] font-bold text-[#134e34]">Grow Your Impact</h2>
                    <p class="text-[12px] font-medium text-[#134e34]/70 mt-0.5">Add more services and help more people live a sustainable life.</p>
                </div>
            </div>
            <a href="{{ route('services.create') }}" class="relative z-10 bg-[#1A4D2E] hover:bg-green-900 text-white font-bold text-sm px-4 py-2 rounded-lg transition-colors flex items-center gap-2 shrink-0 mr-8">
                <span>Add New Service</span>
            </a>
            <button class="text-[#134e34]/50 hover:text-[#134e34] absolute right-6 top-1/2 -translate-y-1/2 hidden sm:block z-10 transition-colors">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        gradient.addColorStop(0, 'rgba(56, 142, 60, 0.25)');   
        gradient.addColorStop(1, 'rgba(56, 142, 60, 0.01)');
        ...
        new Chart(earningsCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: '#388E3C', // darker green line
                    borderWidth: 2.5,
                    tension: 0.4,
                    fill: true,
