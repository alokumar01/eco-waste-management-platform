...
<div class="flex h-screen bg-[#F4F7F6] font-sans overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto bg-[#F4F7F6] p-6 md:p-10 pb-20">
            ...
            <!-- Heading Title block -->
            <div class="mb-8">
                <h1 class="text-[22px] font-bold text-gray-950 leading-none tracking-tight">Add New Service</h1>
                <p class="text-[11.5px] text-gray-500 font-medium mt-1.5">Fill in the details to list your service and reach more customers.</p>
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="service_category" name="category" class="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-provider-green focus:border-provider-green transition-all bg-gray-50/20 appearance-none text-gray-700">
                                            ...
                                            <option value="E-Waste" {{ old('category') == 'E-Waste' ? 'selected' : '' }}>E-Waste</option>
                                            <option value="Organic Waste" {{ old('category') == 'Organic Waste' ? 'selected' : '' }}>Organic Waste</option>
                                            <option value="Garden Waste" {{ old('category') == 'Garden Waste' ? 'selected' : '' }}>Garden Waste</option>
                                            <option value="Commercial Waste" {{ old('category') == 'Commercial Waste' ? 'selected' : '' }}>Commercial Waste</option>
                                        </select>
                            ...
                            <div>
                                ...
                                <div class="border border-gray-200 rounded-xl overflow-hidden bg-white">
                                    ...
                                    <input type="hidden" name="detailed_description" id="detailed_description_hidden" value="{{ old('detailed_description') }}">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white p-3.5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100">
                            ...
                            <p class="text-[9.5px] text-gray-400 font-medium mb-3">Upload images to showcase your service</p>
                                ...
                                @for ($i = 1; $i <= 5; $i++)
                                    <div class="aspect-square border border-gray-100 rounded-lg bg-gray-50/50 flex items-center justify-center cursor-pointer hover:border-provider-green transition-all group overflow-hidden relative" 
                                        ...
                                        <button type="button" 
                                                ...
                                                class="absolute top-1 right-1 bg-red-500 hover:bg-red-600 text-white rounded-full p-0.5 shadow-md transition-all duration-200 opacity-0 group-hover:opacity-100 focus:outline-none z-10 hidden">
