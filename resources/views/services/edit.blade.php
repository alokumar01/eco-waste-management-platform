                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="name" id="service_title" maxlength="100" placeholder="Enter service title" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20" value="{{ old('name', $service->name) }}" required>
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-5">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="price" id="service_price" placeholder="Enter price" step="0.01" class="w-full pl-8 pr-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20" value="{{ old('price', $service->price) }}" required>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="duration" placeholder="e.g., 2 hours, 1 day" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 text-gray-700" value="{{ old('duration', $service->duration) }}">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="what_we_dont_accept" placeholder="e.g., Plastic, Glass, Metal" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 text-gray-700" value="{{ old('what_we_dont_accept', $service->what_we_dont_accept) }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select name="city" class="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 appearance-none text-gray-700">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="additional_areas" placeholder="Select additional areas" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 text-gray-700" value="{{ old('additional_areas', $service->additional_areas) }}">
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 appearance-none text-gray-700">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                            ...
                            <div class="grid grid-cols-5 gap-2 mt-3">
                                @for ($i = 1; $i <= 5; $i++)
                                    ...
                                    <div class="aspect-square border border-gray-100 rounded-lg bg-gray-50/50 flex items-center justify-center cursor-pointer hover:border-green-500 transition-all group overflow-hidden relative" 
                                        ...
                                        @if ($imgPath)
                                            <svg class="w-3.5 h-3.5 text-green-700 group-hover:scale-110 transition-transform hidden" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"></path></svg>
                        ...
                        <div class="bg-white p-3.5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100">
                            ...
                            <div class="border border-gray-100 rounded-2xl p-3.5 text-center bg-white flex flex-col items-center justify-center min-h-[170px]">
                                ...
                                <div id="preview_price_tag" class="mt-2 bg-emerald-50 text-emerald-700 text-[10px] font-bold px-3 py-1 rounded-full transition-all">
                        ...
                        <div class="bg-white p-3.5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100">
                            ...
                            <ul class="space-y-1.5 text-[9.5px] font-semibold text-gray-600">
                                <li class="flex items-center gap-2"><svg class="w-3 h-3 text-green-600 shrink-0" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Keep details up to date</li>
                                <li class="flex items-center gap-2"><svg class="w-3.5 h-3.5 text-green-600 shrink-0" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Highlight what you accept clearly</li>
                                <li class="flex items-center gap-2"><svg class="w-3.5 h-3.5 text-green-600 shrink-0" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg> Set competitive, clear prices</li>
                            </ul>
                        </div>

                        <!-- Widget 4: Submit Buttons -->
                        <div>
                            <button type="submit" class="w-full bg-[#1A4D2E] hover:bg-green-900 text-white font-bold text-sm px-4 py-2 rounded-lg transition-colors">Update Listing</button>
                            <button type="button" onclick="window.location.href='{{ route('services.index') }}'" class="w-full bg-white border border-gray-200 text-gray-700 font-bold py-2.5 px-4 rounded-xl text-xs hover:bg-gray-50 transition-colors shadow-sm">Cancel</button>
                        </div>
