                                ...
                                <tr class="hover:bg-gray-50/30 transition-colors service-row" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-xs font-medium">
                                        <div class="flex items-center justify-end gap-2.5 select-none">
                                            ...
                                            <!-- Delete Form trigger -->
                                            <form action="{{ route('services.destroy', $service->id) }}" method="POST" data-confirm="Are you sure you want to delete this service listing?" data-confirm-title="Delete Service Listing" data-confirm-text="Delete" class="inline">
                                                @csrf
                                                @method('DELETE')
