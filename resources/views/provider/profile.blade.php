...
<div class="flex h-screen bg-[#F4F7F6] font-sans overflow-hidden">
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto bg-[#F4F7F6] p-6 md:p-10 pb-20">
            ...
            @if (session('success'))
                <div class="mb-6 bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded-xl text-sm font-medium">
                    {{ session('success') }}
                </div>
            @endif
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="business_name" id="business_name" required
                                        ...
                                        class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 text-gray-700">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="relative group w-16 h-16 shrink-0 rounded-full overflow-hidden border-2 border-green-600/20 bg-gray-50">
                                            <img id="avatar-preview" src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=E8F5E9&color=1B7339' }}" alt="Profile Picture" class="w-full h-full object-cover">
                                        </div>
                                        <div class="flex-1">
                                            <input type="file" name="profile_picture" id="profile_picture" accept="image/*" class="hidden" onchange="previewAvatar(this)">
                                            <button type="button" onclick="document.getElementById('profile_picture').click()" class="hover:bg-[#F4FCF4] hover:border-[#1A4D2E] active:scale-[0.98] transition-all" style="border: 1px solid #C1E1C9 !important; border-radius: 8px !important; color: #1A4D2E !important; background-color: #ffffff !important; font-weight: 700 !important; font-size: 12px !important; padding: 8px 16px !important; display: inline-flex !important; align-items: center !important; gap: 8px !important; cursor: pointer !important; transition: all 0.2s ease-in-out !important;">
                                                Change Picture
                                            </button>
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        @if($user->verification_document)
                                            <div class="flex items-center gap-2 bg-green-50/50 border border-green-100 rounded-xl p-2.5 text-xs text-green-800">
                                                ...
                                                <a href="{{ asset('storage/' . $user->verification_document) }}" target="_blank" class="text-green-700 hover:text-green-950 font-bold underline whitespace-nowrap">
                                                    View File
                                                </a>
                                            </div>
                                        @endif
                                        <div class="relative">
                                            ...
                                            <button type="button" onclick="document.getElementById('verification_document').click()" class="hover:bg-[#F4FCF4] hover:border-[#1A4D2E] active:scale-[0.98] transition-all" style="border: 1px solid #C1E1C9 !important; border-radius: 8px !important; color: #1A4D2E !important; background-color: #ffffff !important; font-weight: 700 !important; font-size: 12px !important; padding: 10px 16px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important; gap: 8px !important; width: 100% !important; cursor: pointer !important; transition: all 0.2s ease-in-out !important;">
                                                <svg class="w-4 h-4 text-[#1A4D2E]/80" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                        ...
                        <div class="bg-white p-6 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="bio" id="bio" rows="4"
                                    ...
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-green-600 transition-all bg-gray-50/20 resize-none text-gray-700">{{ old('bio', $user->bio) }}</textarea>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="bg-white p-5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100 space-y-4">
                            ...
                            <button type="submit" class="w-full text-white font-bold text-sm hover:bg-green-900 transition-colors" style="background-color: #1A4D2E !important; border: none !important; border-radius: 8px !important; padding: 10px 16px !important; cursor: pointer !important; transition: all 0.2s ease-in-out !important;">
                                Save Profile
                            </button>
                        </div>
                        ...
                        <div class="bg-white p-5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.015)] border border-gray-100">
                            ...
                            <div class="space-y-3.5">
                                ...
                                <div>
                                    ...
                                    @if($user->is_verified)
                                        <span class="inline-flex items-center gap-1.5 text-[10px] font-bold text-green-700 bg-green-50 px-2.5 py-1 rounded-full">
                                            <span class="w-1.5 h-1.5 rounded-full bg-green-500"></span> Verified Provider
                                        </span>
                                    @else
