...
<header class="flex justify-between items-center bg-white border-b border-gray-100 px-6 md:px-10 py-3 shrink-0 z-10 select-none">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="relative hidden sm:block w-[300px]">
            <input type="text" placeholder="Search anything..." class="w-full pl-4 pr-10 py-1.5 border border-gray-100 rounded-xl text-sm bg-gray-50/70 focus:bg-white focus:outline-none focus:ring-1 focus:ring-provider-green focus:border-provider-green transition-all placeholder-gray-400">
